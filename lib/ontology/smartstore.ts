...
export const SMARTSTORE_NODES: OntologyNode[] = [
  ...
  { id: "ss.food.meat.chicken", name: "닭고기/가금류", level: 3, parent: "ss.food.meat",
    matchKeywords: ["닭고기", "닭", "오리", "닭가슴살", "닭발", "닭다리", "닭볶음탕용", "닭날개", "통닭", "닭안심"],
    seedKeywords: [
      "저칼로리 훈제 닭가슴살 30팩", "냉동 닭가슴살 대용량",
      "오리로스 냉동 슬라이스", "삼계탕 세트 국내산",
    ],
    variantKeywords: ["닭가슴살", "닭다리", "닭볶음탕용", "닭날개", "훈제닭가슴살", "통닭", "닭안심", "스테비아닭가슴살", "닭가슴살소시지", "오리훈제슬라이스", "삼계탕재료", "치킨너겟", "닭꼬치"] },

  // L3: 수산물
  { id: "ss.food.meat.seafood", name: "수산물/해산물", level: 3, parent: "ss.food.meat",
    matchKeywords: ["생선", "해산물", "수산", "새우", "오징어", "대게", "킹크랩", "꽃게", "굴", "연어", "참치", "갈치", "고등어", "전복", "랍스터", "홍게"],
    seedKeywords: [
      "왕새우 냉동 대용량", "손질 오징어 통째로",
      "통영 굴 신선 1kg", "킹크랩 냉동 홈파티",
    ],
    variantKeywords: ["연어", "참치", "갈치", "고등어", "전복", "랍스터", "홍게", "활새우", "완도전복", "통영굴", "노르웨이연어", "제주광어", "킹크랩다리", "자숙문어", "손질오징어", "반건조오징어"] },
  ...
  { id: "ss.food.drink.coffee", name: "커피/원두", level: 3, parent: "ss.food.drink",
    matchKeywords: ["커피", "원두", "드립", "콜드브루", "에스프레소", "캡슐커피", "인스턴트커피", "디카페인", "더치커피"],
    seedKeywords: [
      "핸드드립 원두 200g 과테말라", "콜드브루 커피 1L 페트",
      "에스프레소 캡슐 호환 50개", "스페셜티 싱글오리진 원두",
    ],
    variantKeywords: ["원두커피", "캡슐커피", "드립커피", "인스턴트커피", "디카페인커피", "더치커피", "콜드브루원액", "핸드드립세트", "스페셜티원두", "커피드립백", "에스프레소캡슐", "믹스커피", "네스프레소호환캡슐", "싱글오리진원두", "스틱커피", "아이스커피원두", "카누미니"] },
  { id: "ss.food.drink.tea", name: "차/건강음료", level: 3, parent: "ss.food.drink",
    matchKeywords: ["녹차", "말차", "허브차", "콤부차", "보이차", "홍차", "캐모마일", "루이보스", "쟈스민", "보리차", "옥수수차"],
    seedKeywords: [
      "제주 녹차 말차 가루 100g", "콤부차 발효음료 국내산",
      "루이보스 허브차 티백 50개", "보이차 다이어트 차",
    ],
    variantKeywords: ["녹차", "말차", "캐모마일", "루이보스", "쟈스민차", "보리차", "옥수수차", "콤부차", "흑마늘진액", "석류즙", "양배추즙", "ABC주스", "레몬차", "생강차", "제로콜라", "탄산수", "프로틴음료", "비건음료", "히비스커스차", "우엉차"] },
  ...
  { id: "ss.food.processed.frozen", name: "냉동식품", level: 3, parent: "ss.food.processed",
    matchKeywords: ["냉동", "만두", "피자", "냉동밥", "볶음밥", "냉동치킨", "냉동떡갈비"],
    seedKeywords: [
  ...
  { id: "ss.fashion.tops.tshirt", name: "티셔츠/반팔", level: 3, parent: "ss.fashion.tops",
    matchKeywords: ["티셔츠", "반팔", "반팔티", "나시", "민소매", "오버핏티셔츠", "크롭티"],
    seedKeywords: [
  ...
  { id: "ss.fashion.tops.knit", name: "니트/가디건", level: 3, parent: "ss.fashion.tops",
    matchKeywords: ["니트", "가디건", "스웨터", "캐시미어", "반폴라", "터틀넥"],
    seedKeywords: [
  ...
  { id: "ss.fashion.outer.jacket", name: "자켓/코트", level: 3, parent: "ss.fashion.outer",
    matchKeywords: ["자켓", "코트", "블레이저", "트렌치코트", "데님자켓", "울코트"],
    seedKeywords: [
  ...
  { id: "ss.accessory.bag.crossbody", name: "크로스백/숄더백", level: 3, parent: "ss.accessory.bag",
    matchKeywords: ["크로스백", "숄더백", "토트백", "에코백", "미니크로스백", "캔버스토트백"],
    seedKeywords: [
      "미니 크로스백 여성 가죽", "캔버스 토트백 대형",
      "숄더백 가죽 출퇴근", "에코백 접이식 장바구니",
    ],
    variantKeywords: ["미니크로스백", "캔버스토트백", "가죽숄더백", "에코백", "체인크로스백", "호보백", "퀼팅크로스백", "나일론숄더백", "장바구니에코백", "클러치백", "버킷백"] },
  ...
  { id: "ss.accessory.shoes.sneakers", name: "스니커즈/운동화", level: 3, parent: "ss.accessory.shoes",
    ...
    variantKeywords: ["러닝화", "워킹화", "트레일러닝화", "쿠셔닝운동화", "경량운동화", "키높이운동화", "슬립온운동화", "캔버스화", "어글리슈즈", "니트스니커즈", "데일리운동화"] },
  { id: "ss.accessory.shoes.sandals", name: "샌들/슬리퍼", level: 3, parent: "ss.accessory.shoes",
    matchKeywords: ["샌들", "슬리퍼", "플립플롭", "여름 신발", "스트랩샌들", "쿠션슬리퍼"],
    seedKeywords: [
      "여성 스트랩 샌들 여름", "남성 슬리퍼 실내외겸용",
      "플랫폼 샌들 키높이", "쿠션 슬리퍼 발편한",
    ],
    variantKeywords: ["스트랩샌들", "플랫폼샌들", "쿠션슬리퍼", "실내슬리퍼", "플립플롭", "아쿠아슈즈", "에바슬리퍼", "글래디에이터샌들", "통굽샌들", "레인부츠", "오피스슬리퍼"] },
  ...
  { id: "ss.beauty.skincare.moisture", name: "보습/수분", level: 3, parent: "ss.beauty.skincare",
    matchKeywords: ["수분", "보습", "크림", "에센스", "미스트", "수분크림", "세라마이드크림"],
    seedKeywords: [
      "건성 피부 수분 크림", "히알루론산 보습 세럼",
      "수분 미스트 스프레이", "판테놀 진정 에센스",
    ],
    variantKeywords: ["수분크림", "세라마이드크림", "시카크림", "수분앰플", "히알루론산세럼", "수분토너", "레티놀세럼", "나이아신아마이드세럼", "비타민C세럼", "펩타이드세럼", "판테놀에센스", "수분패드", "수면팩"] },
  ...
  { id: "ss.beauty.skincare.cleanser", name: "클렌징/세안", level: 3, parent: "ss.beauty.skincare",
    matchKeywords: ["클렌징", "세안", "폼클렌저", "오일", "클렌징워터", "젤클렌징", "밀크클렌징", "클렌징밤"],
    seedKeywords: [
      "저자극 클렌징 오일 순한", "약산성 폼클렌저",
      "미셀라 클렌징워터 대용량", "딥클렌징 각질제거",
    ],
    variantKeywords: ["폼클렌징", "오일클렌징", "워터클렌징", "젤클렌징", "밀크클렌징", "클렌징밤", "약산성클렌저", "각질제거클렌저", "모공클렌저", "딥클렌징폼", "아미노산클렌저", "클렌징티슈"] },
  ...
  { id: "ss.beauty.makeup.base", name: "베이스", level: 3, parent: "ss.beauty.makeup",
    matchKeywords: ["쿠션", "파운데이션", "BB", "CC", "프라이머", "쿠션파운데이션", "톤업크림"],
    seedKeywords: [
  ...
  { id: "ss.digital.audio.earphone", name: "이어폰/헤드폰", level: 3, parent: "ss.digital.audio",
    ...
    variantKeywords: ["골전도이어폰", "오픈형이어폰", "유선이어폰", "블루투스이어폰", "커널형이어폰", "스포츠이어폰", "에어팟프로", "갤럭시버즈", "ANC이어폰", "게이밍헤드셋", "노이즈캔슬링헤드폰", "TWS이어폰", "에어팟케이스"] },
  ...
  { id: "ss.digital.mobile.battery", name: "보조배터리/충전기", level: 3, parent: "ss.digital.mobile",
    matchKeywords: ["보조배터리", "충전기", "고속충전", "케이블", "고속충전기", "무선충전기"],
    seedKeywords: [
      "보조배터리 20000mAh 대용량", "C타입 고속충전기 65W",
      "3in1 무선충전기 패드", "USB-C 케이블 고속",
    ],
    variantKeywords: ["고속충전기", "멀티충전기", "무선충전기", "차량용충전기", "미니보조배터리", "대용량보조배터리", "GaN충전기", "맥세이프보조배터리", "C타입케이블", "3in1충전패드", "65W충전기", "20000mAh보조배터리", "PD고속충전기"] },
  ...
  { id: "ss.furniture.living.storage", name: "수납/선반", level: 3, parent: "ss.furniture.living",
    ...
    variantKeywords: ["행거", "옷걸이행거", "벽선반", "서랍장", "수납박스", "틈새수납장", "원목수납함", "플라스틱수납함", "3단서랍", "정리함세트", "TV장", "거실장", "콘솔장식장", "책장", "오픈형책장"] },
  ...
  { id: "ss.furniture.lighting.stand", name: "스탠드/무드등", level: 3, parent: "ss.furniture.lighting",
    matchKeywords: ["스탠드", "독서등", "무드등", "수면등", "LED스탠드", "캠핑랜턴"],
    seedKeywords: [
      "LED 독서 스탠드 눈보호", "USB 무드등 수면 터치",
      "클립형 침대 독서등", "캠핑 랜턴 무드등",
    ],
    variantKeywords: ["LED스탠드", "클립스탠드", "무드등", "수면등", "캠핑랜턴", "장스탠드", "플로어스탠드", "식탁등", "센서등", "독서등", "학습스탠드", "수유등", "터치무드등", "프로젝터무드등"] },
  ...
  { id: "ss.sports.fitness.yoga", name: "요가/필라테스", level: 3, parent: "ss.sports.fitness",
    ...
    variantKeywords: ["요가매트", "폼롤러", "요가블럭", "필라테스링", "스트레칭밴드", "요가휠", "TPE요가매트", "논슬립요가매트", "요가타올", "밸런스보수", "요가양말", "필라테스볼", "마사지볼"] },
  { id: "ss.sports.fitness.gym", name: "헬스/웨이트", level: 3, parent: "ss.sports.fitness",
    matchKeywords: ["덤벨", "바벨", "케틀벨", "헬스장갑", "폼롤러", "풀업바", "벤치프레스"],
    seedKeywords: [
      "가정용 조절 덤벨 24kg", "저항밴드 5단계 세트",
      "폼롤러 근막이완 마사지", "힙업 밴드 스쿼트",
    ],
    variantKeywords: ["덤벨", "케틀벨", "풀업바", "홈트레이닝기구", "벤치프레스", "조절덤벨", "저항밴드", "덤벨세트", "복근롤러", "힙업밴드", "턱걸이바", "헬스장갑", "웨이트벨트", "파워랙", "스쿼트랙"] },
  ...
  { id: "ss.health.air.humidity", name: "가습기/제습기", level: 3, parent: "ss.health.air",
    matchKeywords: ["가습기", "제습기", "초음파", "초음파가습기", "미니제습기"],
    seedKeywords: [
      "무소음 초음파 가습기 대용량", "소형 제습기 원룸",
      "자연기화 에어워셔", "미니 USB 가습기 사무실",
    ],
    variantKeywords: ["초음파가습기", "자연기화가습기", "미니가습기", "미니제습기", "에어워셔", "복합가습기", "USB가습기", "대용량가습기", "제습기대용량", "가열식가습기", "무드등가습기", "침실제습기", "옷장제습기"] },
  ...
  { id: "ss.baby.feeding.bottle", name: "젖병/컵", level: 3, parent: "ss.baby.feeding",
    matchKeywords: ["젖병", "빨대컵", "물병", "이유식용기", "PPSU젖병", "아기빨대컵"],
    seedKeywords: [
      "누수방지 아기 빨대컵", "흡착식판 이유식 용기 세트",
      "PPSU 젖병 신생아용", "아기물병 온도표시",
    ],
    variantKeywords: ["PPSU젖병", "아기빨대컵", "이유식용기", "흡착식판", "아기물병", "젖병소독기", "유리젖병", "실리콘젖병", "모유저장팩", "분유통", "스푼포크세트", "이유식마스터기", "이유식냉동큐브"] },
  ...
  { id: "ss.leisure.hobby.art", name: "미술/드로잉", level: 3, parent: "ss.leisure.hobby",
    matchKeywords: ["그림", "수채화", "드로잉", "스케치", "색연필", "아크릴물감", "유화"],
    seedKeywords: [
      "수채화 36색 입문세트", "드로잉 태블릿 보급형",
      "색연필 72색 전문가용", "아크릴 물감 세트",
    ],
    variantKeywords: ["수채화물감", "아크릴물감", "색연필세트", "스케치북", "드로잉펜", "유화물감", "파스텔", "마카세트", "드로잉태블릿", "수채화붓", "캔버스", "이젤", "팔레트", "스케치연필"] },
  { id: "ss.leisure.hobby.craft", name: "공예/DIY", level: 3, parent: "ss.leisure.hobby",
    matchKeywords: ["뜨개질", "레진", "자수", "비즈", "마크라메", "캔들만들기", "석고방향제"],
    seedKeywords: [
      "뜨개질 실 입문세트", "레진 DIY 키트 투명",
      "마크라메 월행잉 세트", "비즈 공예 키트",
    ],
    variantKeywords: ["뜨개질세트", "레진공예", "프랑스자수", "비즈공예", "마크라메", "캔들만들기키트", "석고방향제", "리본공예", "펠트공예", "도자기공예키트", "프리저브드플라워", "가죽공예세트", "DIY비누만들기"] },
  ...
  { id: "ss.leisure.travel.luggage", name: "캐리어/파우치", level: 3, parent: "ss.leisure.travel",
    matchKeywords: ["캐리어", "여행파우치", "여권지갑", "기내반입캐리어", "하드캐리어"],
    seedKeywords: [
      "기내반입 20인치 캐리어", "여행용 화장품 파우치 세트",
      "압축 파우치 의류정리", "여권 지갑 케이스",
    ],
    variantKeywords: ["기내반입캐리어", "하드캐리어", "소프트캐리어", "여행파우치", "여권케이스", "캐리어28인치", "20인치캐리어", "24인치캐리어", "여행용압축팩", "여행용파우치세트", "목베개", "여행용어댑터", "보이어타입캐리어", "기내용크로스백"] },
  ...
  { id: "ss.food.fruit.apple", name: "사과/배", level: 3, parent: "ss.food.fruit",
    matchKeywords: ["사과", "배", "청사과", "홍로", "부사", "신고배", "아오리", "감홍", "황금배"],
    seedKeywords: [
      "경북 부사 사과 5kg 가정용", "꿀사과 청송 산지직송",
      "나주 배 선물세트 7.5kg", "홍로 사과 꿀당도",
      "유기농 사과즙 120포",
    ],
    variantKeywords: ["부사사과", "홍로사과", "아오리사과", "감홍사과", "사과즙", "배즙", "황금배", "시나노골드", "엔비사과", "꿀사과", "신고배", "청송사과", "나주배", "못난이사과"] },
  { id: "ss.food.fruit.berry", name: "딸기/베리류", level: 3, parent: "ss.food.fruit",
    matchKeywords: ["딸기", "블루베리", "라즈베리", "체리", "베리", "설향", "금실", "킹스베리"],
    seedKeywords: [
      "논산 딸기 생딸기 1kg", "냉동 블루베리 미국산 1kg",
      "칠레산 생체리 2kg 항공직송", "유기농 라즈베리 냉동",
      "딸기 세척 설향 500g",
    ],
    variantKeywords: ["설향딸기", "금실딸기", "킹스베리", "냉동딸기", "건블루베리", "냉동블루베리", "논산딸기", "유기농딸기", "생체리", "냉동라즈베리", "아로니아", "크랜베리"] },
  { id: "ss.food.fruit.citrus", name: "감귤/귤", level: 3, parent: "ss.food.fruit",
    ...
    variantKeywords: ["한라봉", "천혜향", "레드향", "황금향", "카라향", "노지감귤", "하우스감귤", "제주감귤", "유기농귤", "감귤즙", "오렌지", "자몽", "만감류선물세트"] },
  { id: "ss.food.fruit.melon", name: "수박/멜론/참외", level: 3, parent: "ss.food.fruit",
    matchKeywords: ["수박", "멜론", "참외", "성주참외", "애플망고", "흑수박", "애플수박", "미니수박"],
    seedKeywords: [
      "성주 참외 산지직송 3kg", "머스크 멜론 선물세트",
      "애플망고 제주산 1kg", "미니 수박 당도선별",
      "꿀참외 가정용 5kg",
    ],
    variantKeywords: ["흑수박", "애플수박", "씨없는수박", "미니수박", "당도선별수박", "성주참외", "꿀참외", "머스크멜론", "애플망고", "골드키위", "파파야"] },
  { id: "ss.food.fruit.grape", name: "포도/샤인머스켓", level: 3, parent: "ss.food.fruit",
    ...
    variantKeywords: ["샤인머스캣", "거봉포도", "캠벨포도", "청포도", "씨없는포도", "냉동포도", "샤인머스켓선물세트", "자이언트포도", "블랙사파이어포도", "포도즙", "머루포도"] },
  ...
  { id: "ss.food.nuts.almond", name: "아몬드/캐슈넛", level: 3, parent: "ss.food.nuts",
    ...
    variantKeywords: ["구운아몬드", "허니버터아몬드", "와사비아몬드", "생캐슈넛", "피스타치오", "마카다미아", "무염아몬드", "통아몬드", "슬라이스아몬드", "볶음캐슈넛", "초코아몬드"] },
  { id: "ss.food.nuts.walnut", name: "호두/잣", level: 3, parent: "ss.food.nuts",
    matchKeywords: ["호두", "잣", "피칸", "브라질넛", "깐호두", "호두강정"],
    seedKeywords: [
      "국산 호두 깐호두 500g", "가평 잣 백잣 100g",
      "피칸 무염 대용량 1kg", "브라질넛 셀레늄 200g",
      "호두 강정 선물세트",
    ],
    variantKeywords: ["깐호두", "가평잣", "피칸", "브라질넛", "호두강정", "호두파이", "통호두", "국산호두", "볶음호두", "꿀호두", "흑호두", "잣가루"] },
  ...
  { id: "ss.food.side.banchan", name: "밑반찬/젓갈", level: 3, parent: "ss.food.side",
    matchKeywords: ["밑반찬", "젓갈", "장아찌", "멸치볶음", "반찬세트", "반찬배달", "새우젓"],
    seedKeywords: [
      "밑반찬 10종 세트 배달", "강경 새우젓 추젓 1kg",
      "장아찌 모음 5종 선물", "맛간장 메추리알 장조림",
      "수제 오이소박이 1kg",
    ],
    variantKeywords: ["밑반찬세트", "반찬배달", "새우젓", "멸치볶음", "장조림", "어리굴젓", "명란젓", "오징어젓", "진미채볶음", "콩자반", "무말랭이", "깻잎조림", "멸치고추장볶음"] },
  ...
  { id: "ss.food.snack.cookie", name: "쿠키/과자", level: 3, parent: "ss.food.snack",
    matchKeywords: ["쿠키", "과자", "크래커", "비스킷", "뻥튀기", "수제마카롱", "버터쿠키"],
    seedKeywords: [
  ...
  { id: "ss.food.snack.hangwa", name: "한과/약과", level: 3, parent: "ss.food.snack",
    matchKeywords: ["한과", "약과", "유과", "강정", "전통과자", "꿀약과", "미니약과"],
    seedKeywords: [
      "수제 약과 꿀약과 선물세트", "유과 세트 설 명절",
      "견과 강정 수제 간식", "전통 한과 모둠 선물",
      "미니약과 대용량 50개입",
    ],
    variantKeywords: ["꿀약과", "미니약과", "유과", "견과강정", "전통한과세트", "수제약과", "모약과", "개성약과", "매작과", "쌀강정", "깨강정", "생강정", "다식"] },
  ...
  { id: "ss.food.sauce.jang", name: "된장/고추장/간장", level: 3, parent: "ss.food.sauce",
    matchKeywords: ["된장", "고추장", "간장", "쌈장", "재래식", "전통장", "재래식된장"],
    seedKeywords: [
      "전통 재래식 된장 1kg", "순창 고추장 국산 고춧가루",
      "양조간장 진간장 1.8L", "쌈장 국산콩 500g",
      "천일염 된장 3년숙성",
    ],
    variantKeywords: ["재래식된장", "순창고추장", "양조간장", "쌈장", "전통장세트", "숙성된장", "청국장", "막장", "진간장", "국간장", "조선간장", "맛간장", "저염된장"] },
  { id: "ss.food.sauce.oil", name: "식용유/참기름", level: 3, parent: "ss.food.sauce",
    matchKeywords: ["참기름", "들기름", "올리브유", "식용유", "아보카도오일", "코코넛오일"],
    seedKeywords: [
      "국산 참기름 320ml 냉압착", "들기름 국내산 생들기름",
      "엑스트라버진 올리브유 1L", "아보카도 오일 스프레이",
      "코코넛오일 유기농 500ml",
    ],
    variantKeywords: ["국산참기름", "생들기름", "엑스트라버진올리브유", "아보카도오일", "코코넛오일", "포도씨유", "MCT오일", "들기름선물세트", "카놀라유", "현미유", "홍화씨유", "해바라기유", "올리브오일스프레이"] },
  { id: "ss.food.sauce.spice", name: "향신료/소스", level: 3, parent: "ss.food.sauce",
    matchKeywords: ["고춧가루", "후추", "카레", "소스", "마늘", "생강", "태양초고춧가루"],
    seedKeywords: [
      "영양 고춧가루 태양초 500g", "통후추 그라인더 세트",
      "스리라차 칠리소스 대용량", "다진마늘 국산 1kg",
      "강황가루 울금 100% 분말",
    ],
    variantKeywords: ["태양초고춧가루", "통후추", "다진마늘", "카레가루", "스리라차소스", "강황가루", "계피가루", "시나몬", "청양고춧가루", "통깨", "볶은참깨", "굴소스", "트러플오일", "소금간장세트"] },
  ...
  { id: "ss.beauty.hair.shampoo", name: "샴푸/린스", level: 3, parent: "ss.beauty.hair",
    ...
    variantKeywords: ["탈모샴푸", "두피샴푸", "약산성샴푸", "무실리콘샴푸", "비듬샴푸", "아미노산샴푸", "두피스케일러", "샴푸린스세트", "염색모샴푸", "볼륨샴푸", "저자극샴푸", "어린이샴푸", "펫샴푸"] },
  { id: "ss.beauty.hair.treatment", name: "트리트먼트/에센스", level: 3, parent: "ss.beauty.hair",
    matchKeywords: ["트리트먼트", "헤어팩", "헤어에센스", "헤어오일", "손상모", "아르간오일"],
    seedKeywords: [
      "손상모 집중 헤어팩 200ml", "아르간 헤어오일 경량",
      "열보호 헤어에센스 드라이전", "단백질 트리트먼트 복구",
      "코코넛 헤어마스크 팩",
    ],
    variantKeywords: ["헤어오일", "헤어팩", "헤어에센스", "단백질트리트먼트", "아르간오일", "헤어마스크", "두피에센스", "리브인컨디셔너", "열보호에센스", "손상모트리트먼트", "코코넛헤어오일", "실크헤어오일"] },
  { id: "ss.beauty.hair.dye", name: "염색/펌", level: 3, parent: "ss.beauty.hair",
    matchKeywords: ["염색", "새치염색", "헤어컬러", "탈색", "염색약", "셀프염색", "헤나"],
    seedKeywords: [
      "새치 커버 셀프 염색약", "애쉬브라운 거품 염색",
      "식물성 천연 헤나 염색", "블리치 탈색제 셀프",
      "컬러 샴푸 보라색 유지",
    ],
    variantKeywords: ["셀프염색약", "새치염색", "거품염색", "헤나염색", "탈색제", "컬러샴푸", "애쉬염색약", "브라운염색약", "보라염색약", "식물성염색약", "샴푸염색", "컬러왁스", "뿌리염색"] },
  ...
  { id: "ss.beauty.body.wash", name: "바디워시/비누", level: 3, parent: "ss.beauty.body",
    ...
    variantKeywords: ["약산성바디워시", "천연수제비누", "아토피바디워시", "샤워젤", "클렌징바", "보습바디워시", "핸드워시", "버블바스", "향기바디워시", "저자극세정제", "도브비누", "유아바디워시"] },
  { id: "ss.beauty.body.lotion", name: "바디로션/크림", level: 3, parent: "ss.beauty.body",
    matchKeywords: ["바디로션", "바디크림", "바디버터", "보습크림", "핸드크림", "바디밀크"],
    seedKeywords: [
      "시어버터 바디크림 대용량", "아토피 세라마이드 로션",
      "핸드크림 선물세트 미니", "바디밀크 촉촉한 향기",
      "요소 크림 건조 갈라짐",
    ],
    variantKeywords: ["시어버터바디크림", "세라마이드로션", "핸드크림세트", "바디밀크", "요소크림", "바디버터", "바디로션대용량", "바디오일", "풋크림", "넥크림", "아기로션", "바디에센스"] },
  { id: "ss.beauty.body.scrub", name: "각질/제모", level: 3, parent: "ss.beauty.body",
    matchKeywords: ["각질제거", "스크럽", "제모", "왁싱", "바디스크럽", "필링젤"],
    seedKeywords: [
      "솔트 바디스크럽 각질제거", "AHA 필링 젤 얼굴 바디",
      "왁싱 스트립 다리 제모", "풋필링 발각질 팩",
      "슈가 스크럽 입술 각질",
    ],
    variantKeywords: ["솔트스크럽", "필링젤", "왁싱스트립", "풋필링", "슈가스크럽", "제모크림", "AHA필링", "BHA각질제거", "전동제모기", "브라질리언왁싱", "각질제거장갑", "발각질제거기"] },
  ...
  { id: "ss.beauty.nail.polish", name: "네일폴리시/젤", level: 3, parent: "ss.beauty.nail",
    matchKeywords: ["매니큐어", "젤네일", "젤폴리시", "셀프젤네일", "탑코트", "셀프네일"],
    seedKeywords: [
      "셀프 젤네일 세트 LED램프", "원스텝 젤폴리시 인기색",
      "빠른건조 매니큐어 누드톤", "네일 탑코트 광택 지속",
      "수성 어린이 매니큐어 무독성",
    ],
    variantKeywords: ["셀프젤네일세트", "젤폴리시", "빠른건조매니큐어", "네일탑코트", "LED네일램프", "셀프네일키트", "젤네일", "원스텝젤", "매니큐어세트", "네일베이스코트", "글리터네일", "네일리무버", "큐티클오일"] },
  { id: "ss.beauty.nail.art", name: "네일아트/스티커", level: 3, parent: "ss.beauty.nail",
    matchKeywords: ["네일스티커", "네일아트", "네일팁", "젤스티커", "프렌치네일", "세미큐어"],
    seedKeywords: [
      "젤네일 스티커 붙이는 세미큐어", "프렌치 네일팁 셀프",
      "글리터 네일아트 파츠 세트", "크리스마스 네일 스티커",
      "풀커버 네일팁 투명 500매",
    ],
    variantKeywords: ["세미큐어젤", "젤네일스티커", "프렌치네일팁", "네일파츠", "풀커버네일팁", "글리터네일", "네일스티커", "붙이는네일", "큐빅네일", "네일아트브러쉬", "젤램프", "네일드릴기"] },
  ...
  { id: "ss.beauty.perfume.diffuser", name: "디퓨저/캔들", level: 3, parent: "ss.beauty.perfume",
    matchKeywords: ["디퓨저", "캔들", "향초", "차량방향제", "섬유향수", "소이캔들", "인센스스틱"],
    seedKeywords: [
      "리드 디퓨저 200ml 거실", "소이캔들 향초 선물세트",
      "차량용 방향제 송풍구", "섬유향수 옷 스프레이",
      "인센스 스틱 백단향 명상",
    ],
    variantKeywords: ["리드디퓨저", "소이캔들", "인센스스틱", "차량방향제", "섬유향수", "아로마캔들", "미니디퓨저", "방향제스프레이", "캔들워머", "왁스멜트", "화장실방향제", "현관방향제"] },
  ...
  { id: "ss.digital.camera.mirrorless", name: "미러리스/DSLR", level: 3, parent: "ss.digital.camera",
    matchKeywords: ["미러리스", "DSLR", "렌즈", "바디", "풀프레임", "APS-C", "입문미러리스"],
    seedKeywords: [
      "입문용 미러리스 카메라 세트", "풀프레임 미러리스 바디",
      "단렌즈 50mm F1.8 인물용", "번들킷 렌즈 포함 미러리스",
      "카메라 가방 숄더백 방수",
    ],
    variantKeywords: ["입문미러리스", "풀프레임미러리스", "단렌즈", "카메라가방", "줌렌즈", "미러리스바디", "소니미러리스", "캐논미러리스", "후지미러리스", "DSLR바디", "번들렌즈", "카메라스트랩", "카메라삼각대"] },
  { id: "ss.digital.camera.action", name: "액션캠/브이로그", level: 3, parent: "ss.digital.camera",
    matchKeywords: ["액션캠", "고프로", "짐벌", "브이로그", "셀카봉", "삼각대", "방수액션캠"],
    seedKeywords: [
      "4K 액션캠 방수 브이로그", "스마트폰 짐벌 3축 안정화",
      "무선 셀카봉 삼각대 겸용", "고프로 마운트 액세서리",
      "브이로그 카메라 소형 경량",
    ],
    variantKeywords: ["방수액션캠", "스마트폰짐벌", "셀카봉삼각대", "브이로그카메라", "고프로액세서리", "4K액션캠", "고프로히어로", "DJI오즈모", "액션캠마운트", "브이로그마이크", "카메라조명", "360도카메라"] },
  { id: "ss.digital.camera.instant", name: "즉석카메라/필름", level: 3, parent: "ss.digital.camera",
    matchKeywords: ["폴라로이드", "즉석카메라", "인스탁스", "필름카메라", "감성카메라", "인스탁스미니"],
    seedKeywords: [
      "인스탁스 미니 즉석카메라", "폴라로이드 필름 20매입",
      "필름카메라 입문 수동 35mm", "즉석카메라 선물세트 케이스",
      "감성 다회용 필름카메라",
    ],
    variantKeywords: ["인스탁스미니", "폴라로이드필름", "필름카메라", "즉석카메라선물", "다회용필름카메라", "인스탁스필름", "폴라로이드카메라", "인스탁스와이드", "인스탁스스퀘어", "35mm필름", "필름카메라케이스", "감성카메라"] },
  ...
  { id: "ss.digital.laptop.ultrabook", name: "울트라북/사무용", level: 3, parent: "ss.digital.laptop",
    matchKeywords: ["울트라북", "사무용노트북", "경량노트북", "그램", "슬림노트북", "맥북에어"],
    seedKeywords: [
      "경량 14인치 노트북 1kg 이하", "대학생 노트북 가성비",
      "사무용 노트북 i5 16GB", "맥북에어 M시리즈 최신",
      "LG그램 15인치 초경량",
    ],
    variantKeywords: ["LG그램", "맥북에어", "경량노트북", "대학생노트북", "사무용노트북", "가성비노트북", "울트라북", "2in1노트북", "터치스크린노트북", "삼성갤럭시북", "14인치노트북", "16인치노트북", "i7노트북"] },
  ...
  { id: "ss.digital.tablet.ipad", name: "아이패드/갤럭시탭", level: 3, parent: "ss.digital.tablet",
    ...
    variantKeywords: ["아이패드", "갤럭시탭", "아이패드미니", "가성비태블릿", "학생용태블릿", "안드로이드태블릿", "아이패드프로", "아이패드에어", "갤럭시탭S9", "전자책리더", "킨들", "크레마"] },
  ...
  { id: "ss.digital.smarthome.speaker", name: "AI스피커/허브", level: 3, parent: "ss.digital.smarthome",
    ...
    variantKeywords: ["AI스피커", "스마트홈허브", "디스플레이스피커", "클로바스피커", "미니AI스피커", "에코닷", "구글네스트", "기가지니", "카카오미니", "알렉사스피커", "AI비서"] },
  { id: "ss.digital.smarthome.security", name: "홈캠/도어락", level: 3, parent: "ss.digital.smarthome",
    matchKeywords: ["홈캠", "CCTV", "도어락", "현관카메라", "베이비캠", "IP카메라", "스마트도어락"],
    seedKeywords: [
      "가정용 홈캠 360도 회전", "스마트 도어락 지문인식",
      "야간 적외선 IP 카메라", "베이비캠 양방향 음성",
      "현관 비디오 도어벨 무선",
    ],
    variantKeywords: ["가정용홈캠", "스마트도어락", "IP카메라", "베이비캠", "비디오도어벨", "지문인식도어락", "360도홈캠", "펫캠", "야외CCTV", "무선홈캠", "현관카메라", "스마트금고"] },
  { id: "ss.digital.smarthome.plug", name: "스마트 플러그/조명", level: 3, parent: "ss.digital.smarthome",
    ...
    variantKeywords: ["스마트플러그", "스마트전구", "LED스트립", "스마트멀티탭", "센서조명", "타이머콘센트", "WiFi플러그", "스마트커튼", "RGB전구", "무선스위치", "인체감지센서", "스마트커튼모터"] },
  ...
  { id: "ss.furniture.bedroom.bed", name: "침대/프레임", level: 3, parent: "ss.furniture.bedroom",
    matchKeywords: ["침대", "침대프레임", "저상침대", "이층침대", "접이식침대", "원목침대", "호텔침대", "싱글침대"],
    seedKeywords: [
      "퀸 저상 침대프레임 원목", "슈퍼싱글 수납 침대",
      "이층침대 아이방 철제", "접이식 간이침대 원룸",
      "호텔식 침대 헤드보드 포함",
    ],
    variantKeywords: ["저상침대", "수납침대", "접이식침대", "이층침대", "원목침대", "호텔침대", "싱글침대", "슈퍼싱글침대", "퀸침대", "킹침대", "가죽침대", "LED침대", "매트리스프레임", "철제침대"] },
  { id: "ss.furniture.bedroom.closet", name: "옷장/행거", level: 3, parent: "ss.furniture.bedroom",
    matchKeywords: ["옷장", "워드로브", "행거", "옷걸이", "드레스룸", "조립식옷장", "커버행거"],
    seedKeywords: [
      "조립식 옷장 대형 800L", "스틸 행거 이동식 튼튼한",
      "파이프 드레스룸 조립 DIY", "원목 옷장 슬라이딩 도어",
      "커버 행거 먼지방지 대형",
    ],
    variantKeywords: ["조립식옷장", "커버행거", "이동식행거", "파이프드레스룸", "원목옷장", "슬라이딩옷장", "시스템옷장", "수납옷장", "행거선반", "스탠드행거", "와이드옷장", "어린이옷장"] },
  ...
  { id: "ss.health.kitchen.cookware", name: "냄비/프라이팬", level: 3, parent: "ss.health.kitchen",
    matchKeywords: ["냄비", "프라이팬", "웍", "궁중팬", "주물냄비", "압력솥", "인덕션냄비", "코팅프라이팬"],
    seedKeywords: [
  ...
  { id: "ss.food.dairy.yogurt", name: "요거트", level: 3, parent: "ss.food.dairy",
    matchKeywords: ["요거트", "요거", "그릭요거트", "요플레", "발효유", "단백질요거트"],
    seedKeywords: [
  ...
  { id: "ss.food.grain.rice", name: "쌀", level: 3, parent: "ss.food.grain",
    matchKeywords: ["쌀", "백미", "햅쌀", "이천쌀", "무농약쌀", "현미", "즉석밥"],
    seedKeywords: [
  ...
  { id: "ss.health.car.interior", name: "차량 실내용품", level: 3, parent: "ss.health.car",
    matchKeywords: ["시트커버", "차량방향제", "핸들커버", "차량수납", "차량충전기", "핸드폰거치대"],
    seedKeywords: [
  ...
  { id: "ss.health.car.exterior", name: "세차/외부용품", level: 3, parent: "ss.health.car",
    matchKeywords: ["세차", "코팅", "워셔액", "블랙박스", "차량커버", "셀프세차"],
    seedKeywords: [
